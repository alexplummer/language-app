...
var app = function () {
    ...
    var appBlur = function appBlur() {
        ...
        function onchange(evt) {
            ...
            if (evt.type in evtMap) cl(evtMap[evt.type]);else location.reload();
        }
    ...
    var progressBar = function progressBar() {
        ...
        var completed = Object.keys(ops$1.storedData.viewedTerms).length;
        var remaining = Object.keys(appData.terms).length;
    ...
    // Imports
    var sheetURL = "https://docs.google.com/spreadsheets/d/1Q1pmDXybg_GDB6bSXknuBET2Nm8L-Roi2Kj01SHm_WI/pubhtml";
    var tinyTermsData = {};
    ...
    var getData = function getData(sheetURL) {
        ...
        function buildData(data) {
            var listName = data.Sheet1.columnNames[1];
    ...
    var appBuildHandler = function appBuildHandler() {
        ...
        if (ops$1.storedData.newDay === true) {
            ...
            delete ops$1.storedData.dailyQuery;
            delete ops$1.storedData.dailyReminder;
        ...
        if (ops$1.storedData.viewedTerms !== undefined && ops$1.storedData.queryComplete !== true && ops$1.storedData.newDay === true) {
            createNewQuery();
        }
