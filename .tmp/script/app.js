    ...
    localforage.getItem('tinyTerms.uploadedLists', function (err, uploadedLists) {
      ...
      var _loop = function _loop(i) {
        categoryBtn[i].addEventListener('click', function (e) {
          ...
          var categoryType = categoryBtn[i].innerHTML;
          var lists = "";
    ...
    function navListeners() {
      ...
      var _loop2 = function _loop2(_i) {
        ...
        removeList[_i].addEventListener('click', function (e) {
          e.preventDefault();
          var insertPoint = removeList[_i].nextSibling;
          document.querySelector('.create-list').classList.add('hidden');
          removeList[_i].classList.add('hidden');
          removeList[_i].parentNode.insertBefore(document.createElement("div"), insertPoint.nextSibling);
          ...
          document.querySelector('.delete-confirm').addEventListener('click', function () {
            ...
            localforage.setItem('tinyTerms.uploadedLists', tinyTerms$1.uploadedLists, function () {
              removeList[_i].parentNode.removeChild(insertPoint.nextSibling);
              removeList[_i].parentNode.parentNode.removeChild(document.querySelector('.' + makeSafeClass(listName)));
          ...
          document.querySelector('.delete-cancel').addEventListener('click', function () {
            removeList[_i].parentNode.removeChild(insertPoint.nextSibling);
            removeList[_i].classList.remove('hidden');
